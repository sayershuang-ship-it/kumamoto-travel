...
### 🆕 `/new` 開新旅程精靈（2026-07-16 追加）
- 輸入目的地、開始日期、天數（1-30）、人數、總預算 → 即時預覽 → 產生每日空白骨架（抵達日/自由安排/返程日，含星期自動計算）
- 旅程設定以 **meta overlay**（`kumamoto-tripmeta-v1`）覆寫範本的標題/日期/人數/預算；
  規劃工作台、匯入頁、.ics 匯出、分享連結、備份還原全部跟著新旅程走
- 規劃工作台「重置」可一鍵回到熊本範本；已有自訂行程時會提醒先備份再覆蓋
- 限制：Day 頁面、地圖、美食、天氣等靜態頁仍為熊本範本內容（頁面上有標註）
